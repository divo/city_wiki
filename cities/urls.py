...
urlpatterns = [
    ...
    path('generate/reword/', views.generate_reword, name='generate_reword'),
    ...
    path('city/<str:city_name>/generate/', views.generate_text_view, name='generate_text_view'),
    path('city/<str:city_name>/generate/text/', views.generate_text, name='generate_text'),
